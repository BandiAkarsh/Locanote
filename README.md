...
- **Shared Element Transitions**: A fluid, cinematic interface where note cards physically morph into the editor for a "Portal" experience.
...
- **Security**: XSalsa20-Poly1305 (TweetNaCl)

---

Built with ❤️ by [Bandi Akarsh](https://github.com/BandiAkarsh).
*Reclaiming data sovereignty for the decentralized web.*
