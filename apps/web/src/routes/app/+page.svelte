...
<script lang="ts">
  ...
  function scrollToNotes() {
    const notesSection = document.querySelector('.bg-white.dark\\:bg-gray-800.rounded-xl');
    if (notesSection) {
...
<div class="space-y-6">
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
    ...
    <button 
      ...
      class="p-6 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-purple-500 dark:hover:border-purple-400 hover:shadow-lg transition-all text-left group"
    >
    ...
    <button 
      ...
      class="p-6 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-pink-500 dark:hover:border-pink-400 hover:shadow-lg transition-all text-left group"
    >
