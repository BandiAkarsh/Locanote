...
>
  ...
  <div class="glass-2 p-8 sm:p-12 rounded-[3rem] space-y-10">
    <header class="text-center space-y-4">
      <div
        class="w-20 h-20 mx-auto bg-primary/10 rounded-3xl flex items-center justify-center border border-primary/20 shadow-glow"
      >
        <svg
      ...
      <h1
        class="text-4xl font-black text-[var(--ui-text)] tracking-tighter leading-none"
      >
        Materialize Identity
      </h1>
      <p class="text-[var(--ui-text-muted)] font-medium">
        Create your unique neural link to the Locanote network.
      </p>
    </header>
    ...
    >
      ...
      {#if !selectedMethod}
        <div class="space-y-4" in:fade>
          <span
            class="block text-[10px] font-black uppercase tracking-[0.2em] text-[var(--ui-text-muted)] ml-4"
            >Select Security Layer</span
          >
          <button
            type="button"
          ...
          >
            <div
              class="w-12 h-12 rounded-xl bg-white/5 flex items-center justify-center group-hover:border-primary/50 border border-transparent transition-all"
            >
              <svg
        ...
        <div class="space-y-4" in:fly={{ x: 20 }}>
          <div class="space-y-2">
            ...
            <input
              ...
              class="w-full px-6 py-4 rounded-2xl bg-white/5 border border-white/10 text-[var(--ui-text)] focus:outline-none focus:border-primary transition-all"
            />
          </div>
          <div class="space-y-2">
            <label
      ...
      {:else}
        <div in:fade class="space-y-6">
          <p class="text-sm text-[var(--ui-text-muted)] text-center">
            Ready to link your device biometrics to <b>{username}</b>.
          </p>
          <button
            type="submit"
    ...
    {#if authState.status === "error"}
      <div
        class="p-4 rounded-2xl bg-red-500/10 border border-red-500/20 text-red-400 text-sm flex items-center gap-3 animate-in fade-in zoom-in-95"
      >
        <svg
    ...
    <footer class="text-center pt-8 border-t border-white/5">
      <button
        ...
        class="text-sm font-bold text-primary hover:underline underline-offset-8 transition-all"
        >Existing Identity? Re-stabilize</button
      >
    </footer>
  </div>
</div>
