  ...
  {#if showTimer}
    ...
    >
      <svg
        ...
        stroke="currentColor"
        stroke-width="3"
        class={isPaused ? "" : "animate-spin-slow"}
      ...
      <div class="flex items-center gap-1 ml-1 border-l border-white/20 pl-2">
        ...
        >
          {#if isPaused}
            <svg
              ...
              height="10"
              viewBox="0 0 24 24"
              fill="currentColor"><path d="M5 3l14 9-14 9V3z" /></svg
            >
          {:else}
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <button
          onclick={stopTimer}
          class="hover:scale-110 transition-transform text-white/80 hover:text-white"
          title="Stop"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            ...
            height="10"
            viewBox="0 0 24 24"
            fill="currentColor"><path d="M6 6h12v12H6z" /></svg
          >
        </button>
      </div>
    </div>
