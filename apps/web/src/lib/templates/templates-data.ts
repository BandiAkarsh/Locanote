            ...
            content: [
              {
                type: "paragraph",
                content: [
                  { type: "text", text: "[Something you are grateful for]" },
                ],
              },
            ],
          },
  ...
  content: {
    ...
    content: [
            ...
            content: [
              {
                type: "paragraph",
                content: [
                  { type: "text", text: "[Task 2 - Priority: Medium]" },
                ],
              },
            ],
          },
      ...
      },
      {
        type: "paragraph",
        content: [
          { type: "text", text: "[Team members, budget, tools needed]" },
        ],
      },
    ],
  },
  ...
  content: {
    ...
    content: [
      ...
      },
      {
        type: "paragraph",
        content: [
          { type: "text", text: "[Tips, substitutions, or variations]" },
        ],
      },
    ],
  },
  ...
  content: {
    ...
    content: [
      ...
      },
      {
        type: "paragraph",
        content: [
          { type: "text", text: "[What was difficult? What blocked you?]" },
        ],
      },
      {
        type: "heading",
